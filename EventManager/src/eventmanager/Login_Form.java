...
public class Login_Form extends javax.swing.JFrame {
  ...
  int port;
    ...
    private void initComponents() {
        ...
        p1.setMinimumSize(new java.awt.Dimension(500, 500));
        p1.setVisible(false);

        l1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        l1.setText("Password or username incorrect");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String str="select * from arpit.login where user=? and password=?";
      try {
        ...
        if(rs.next())
        {
            Success sc=new Success(add,port);
            sc.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        add=txtIP.getText();
        port=Integer.parseInt(txtPort.getText());
        Register rg = new Register(add,port);
        rg.setVisible(true);
        this.setVisible(false);
