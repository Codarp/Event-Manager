...
public class Registration_Form extends javax.swing.JFrame {
    ...
    public Registration_Form(String str,String add,int port) {
        label="Registration";
        initComponents();
        this.add=add;
        this.port=port;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            dout.writeUTF(label);
            dout.writeUTF(l1.getText());
            dout.writeUTF(txtName.getText());
            dout.flush();
            String abc=din.readUTF();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Registration_Form(null,null,0).setVisible(true);
            }
        });
    }
